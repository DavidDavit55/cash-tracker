...
const SOURCES = [
  {
    ...
    accept: '.xlsx,.xls',
    field: 'file',
    endpoint: '/import/discount',
    instructions: ['דיסקונט → עסקאות → עובר ושב', 'ייצוא → Excel'],
  },
  {
    id: 'discount-visa',
    name: 'ויזה דיסקונט',
    ...
    accept: '.xlsx,.xls',
    field: 'file',
    endpoint: '/import/discount-visa',
    instructions: ['דיסקונט → כרטיסי אשראי → פירוט עסקאות וזיכויים', 'ייצוא → Excel'],
  },
  {
    id: 'transaction-details',
    name: 'מקס (transaction-details)',
    icon: '💳',
    color: '#dc2626',
    accept: '.xlsx,.xls',
    field: 'file',
    endpoint: '/import/transaction-details',
    instructions: ['max.co.il → עסקאות → ייצוא', 'בחר "transaction-details" Excel'],
  },
  {
    id: 'cal',
    name: 'כאל אשראי',
    ...
    field: 'file',
    endpoint: '/import/cal',
    instructions: ['cal-online.co.il → עסקאות → פירוט עסקאות', 'ייצוא Excel'],
  },
  {
    id: 'max',
    name: 'מקס (פירוט ישן)',
    ...
    field: 'file',
    endpoint: '/import/max',
    instructions: ['max.co.il → עסקאות → פירוט עסקאות', 'ייצוא Excel (פורמט ישן)'],
  },
  {
    id: 'riseup',
    name: 'רייזאפ',
    ...
    accept: '.csv',
    field: 'csv',
    endpoint: '/import/riseup',
    instructions: ['פתח רייזאפ', 'עסקאות → ייצוא', 'שמור כ-CSV'],
  },
];
