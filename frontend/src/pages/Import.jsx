...
const SOURCES = [
  {
    ...
    instructions: ['היכנס לאתר/אפליקציה של דיסקונט', 'עסקאות → עובר ושב', 'לחץ על ייצוא → Excel'],
  },
  {
    id: 'cal',
    name: 'כאל אשראי',
    ...
    field: 'file',
    endpoint: '/import/cal',
    instructions: ['היכנס ל-cal-online.co.il', 'עסקאות → פירוט עסקאות', 'ייצוא Excel'],
  },
  {
    id: 'max',
    name: 'מקס אשראי',
    ...
    field: 'file',
    endpoint: '/import/max',
    instructions: ['היכנס ל-max.co.il', 'עסקאות → פירוט עסקאות', 'ייצוא Excel'],
  },
  {
    id: 'riseup',
    name: 'רייזאפ',
